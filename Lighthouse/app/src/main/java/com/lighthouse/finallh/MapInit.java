...
public class MapInit extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (servicesOK()) {
            ...
            if (initMap()) {
                gotoLocation(CSUN_LAT, CSUN_LNG, 16);
            ...
            if (mMap != null) {
                ...
                mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                    ...
                    public void onMapLongClick(LatLng latLng) {
                        Geocoder gc = new Geocoder(MapInit.this);
                        ...
                        MapInit.this.addMarker(add, latLng.latitude, latLng.longitude);
                    }
                });
                ...
                mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(Marker marker1) {
                        ...
                        Toast.makeText(MapInit.this, msg, Toast.LENGTH_SHORT).show();
                        return false;
                    }
                });
                ...
                mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                    ...
                    public void onInfoWindowClick(Marker marker1) {
                        ...
                        Intent intent = new Intent(MapInit.this, FilterEventByLocation.class);
                        // intent.putExtra("locationName", marker1.getTitle());
    ...
    public void geoLocate(View v) throws IOException {
        ...
        //final static LatLng PERTH1 = new LatLng(lat1, lon);
        ...
        // Geocoder gc = new Geocoder(this);
        //  List<Address> list = gc.getFromLocation(locations[index][0], locations[index][1], 1);
    ...
    public void addMarker(Address add, double lat, double lng) {
        MarkerOptions option = new MarkerOptions() //moe
                .title(add.getLocality())
                .position(new LatLng(lat, lng))
                .draggable(true);


        option.icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher));

        marker1 = mMap.addMarker(option);
